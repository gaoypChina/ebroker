...
class _AddPropertyDetailsState extends State<AddPropertyDetails> {
  ...
  void _onTapChooseLocation(FormFieldState state) async {
    ...
    if (latlng != null && place != null) {
      ...
      _latitudeController.text = '32';
      _longitudeController.text = '32';
      _cityNameController.text = "";
      _countryNameController.text = "";
      _stateNameController.text = "";
      _addressController.text = "";
      _addressController.text = '32';
      // log(City().get());
      state.didChange(true);
    ...
    return Scaffold(
      ...
      appBar: UiUtils.buildAppBar(
        ...
        title: widget.properyDetails == null
            ? UiUtils.getTranslatedLabel(context, "Add Product Detail")
            : UiUtils.getTranslatedLabel(context, "Update Product"),
        actions: const [
          Text("2/4"),
          SizedBox(
            width: 14,
        ...
        child: SingleChildScrollView(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(UiUtils.getTranslatedLabel(context, "Product Name")),
                SizedBox(
                ...
                CustomTextFormField(
                  ...
                  hintText: UiUtils.getTranslatedLabel(context, "Product Name"),
                ),
                SizedBox(
                  height: 15.rh(context),
                ),
